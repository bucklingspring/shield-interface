var WE_visualizer = (function($, createjs) {
    ...
    _.draw = function() {
        ...
        var spacing = 5; // spacing between lines in pixels
        var lineWidth = 3; // width of lines in pixels
        var lineHeightMultiplier = 100; // multiplier for length * audioValue to pixels
        ...
        for (var x = 0; x < transitionAudioData.length; x++) {
            ...
            line.graphics.setStrokeStyle('100%', "round")
